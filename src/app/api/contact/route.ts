  ...
  try {
    ...
    const userConfirmationHtml = `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        ...
        <hr>
        <p>If this is an emergency, please call us directly at <strong>+91 7554026900 </strong>.</p>
        <p>📧 samarpanhospitalonline@gmail.com</p>
    ...
    const adminInfo = await transporter.sendMail({
      ...
      to: process.env.EMAIL_RECEIVER || "samarpanhospitalonline@gmail.com",
