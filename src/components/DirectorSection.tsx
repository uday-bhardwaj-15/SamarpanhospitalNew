  ...
  return (
    <section className="section-padding relative overflow-hidden bg-muted/30">
      ...
      <div className="absolute top-20 left-10 opacity-5">
        <svg width="200" height="240" viewBox="0 0 200 240" fill="currentColor" className="text-primary">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.02]">
        <svg width="600" height="720" viewBox="0 0 200 240" fill="currentColor" className="text-primary">
          <path d="M100 0C60 0 30 30 20 70C10 110 20 150 40 180C60 210 90 240 100 240C110 240 140 210 160 180C180 150 190 110 180 70C170 30 140 0 100 0ZM80 60C90 50 110 50 120 60C130 70 130 90 120 100C110 110 90 110 80 100C70 90 70 70 80 60Z"/>
        </svg>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-4xl overflow-hidden shadow-hover">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="text-white/80 text-lg">Director & Chief Nephrologist</p>
              </div>
            </div>
            ...
            <div className="absolute -top-6 -right-6 glass rounded-2xl p-4 shadow-card animate-float">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-bold text-foreground">10+ Years</div>
          ...
          <div>
            ...
            <blockquote className="text-xl md:text-2xl font-medium text-foreground leading-relaxed mb-8 italic">
              "At Samarpan Hospital, we believe every patient deserves access to world-class kidney care. 
              Our mission is to combine cutting-edge medical technology with the warmth of 
              compassionate healing, ensuring that every individual who walks through our doors 
              receives not just treatment, but hope."
            </blockquote>

            <p className="text-muted-foreground leading-relaxed mb-8">
              With over three decades of experience in nephrology and transplant medicine, 
              I founded Samarpan Hospital with a singular vision — to create a center of excellence 
              that prioritizes patient outcomes above all else. Today, we stand proud as 
              one of India's most trusted kidney care institutions.
            </p>

            {/* Director Stats */}
            <div className="grid grid-cols-3 gap-4">
              {[
                { icon: Stethoscope, number: "20,000+", label: "Patients Treated" },
                { icon: Heart, number: "500+", label: "Transplants" },
                { icon: Award, number: "25+", label: "Awards" },
              ].map((stat, index) => (
                <div key={index} className="text-center p-4 rounded-2xl bg-background shadow-soft">
                  <stat.icon className="w-6 h-6 text-primary mx-auto mb-2" />
                  <div className="text-xl font-bold text-gradient">{stat.number}</div>
